...
const Footer = () => {
  return (
    <footer id="footer" className="bg-danger">
      ...
      <p> Our mission as Shopping Mall is to provide consumers with the most accurate and up-to-date information on the prices of products and up-to-date information on </p>
      {/*
